function t5_on_spfr_fit_wrap_delta4(task_id)
...
lb = [.1       .1,     -5,    0.1,       .1       .1,      0,    -5,    0.1,   0];
ub = [70,      70,     7,     10,       70,      70,     5,     7,      12,  10];
...
tic
foldername = [basedir,'/xfits_T5/delta4/',...
...
%    spfr_data.pos_vect = spfr_data.pos_vect + width;
%end
