function t5_off_spfr_fit_wrap_classic4(task_id)
...
basedir = pwd;
tic    
load(sprintf('T5_spfr_structs/spfr_ds_cell%d_dur%d_width%d_val0.mat',cell_num,stim_dur,width),'spfr_ds')
fprintf('Load Time:%d\n',fix(toc))
catch
    continue
end
...
load(sprintf('T5_spfr_structs/pd_ds_cell%d_dur%d_width%d_val0.mat',cell_num,stim_dur,width),'pd_ds')
load(sprintf('T5_spfr_structs/nd_ds_cell%d_dur%d_width%d_val0.mat',cell_num,stim_dur,width),'nd_ds')
load(sprintf('T5_spfr_structs/spfr_ds_cell%d_dur%d_width%d_val0.mat',cell_num,stim_dur,width),'spfr_ds')
catch
    continue
end
